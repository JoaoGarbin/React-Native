...
export function Start() {
    ...
    const backStarsOpacity = useSharedValue(0.1)
    const frontStarsOpacity = useSharedValue(0.1)

    backStarsOpacity.value = withRepeat(
        withTiming(1, { duration: 1500, easing: Easing.ease }),
        0,
        true
    )

    frontStarsOpacity.value = withRepeat(
