    ...
    return (
        <TouchableOpacity onPress={onPress} className='flex flex-col items-start w-60 h-80 relative'>
            ...
            <View className='flex flex-col items-start absolute bottom-5 inset-x-5'>
                ...
                <Text className='text-base font-rubik text-white'> 22 W 15th St, New York, NY 1001 </Text>
...
export const Card = () => {
    return (
        <TouchableOpacity className='flex-1 w-full mt-4 px-3 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70 relative'>
            <View className="flex flex-row items-center bg-white/90 px-3 py-1.5 rounded-full absolute top-5 right-5 p-1 z-50" >
                <Image source={icons.star} className='size-3.5' />
            ...
            <View className='flex flex-col mt-2'>
                ...
                <View className='flex flex-row items-center justify-between mt-2'>
                    ...
                    <Image source={icons.heart} className='w-5 h-5 size-5 mr-2' tintColor="#191d31" />
